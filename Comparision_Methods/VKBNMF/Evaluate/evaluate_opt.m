...
AUC = 0.5*AUC_x(1)*AUC_y(1)*coeff+coeff*sum((AUC_x(2:end)-AUC_x(1:end-1)).*(AUC_y(2:end)+AUC_y(1:end-1))/2);
...
temp_f1=2*coeff*recall.*temp_precision./(recall+temp_precision);
[~,index]=max(temp_f1);
%%
f1=temp_f1(index);
%%%
