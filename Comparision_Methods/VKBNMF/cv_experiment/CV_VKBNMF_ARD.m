function result = CV_VKBNMF_ARD(cv_flag,data_num)
%disp('suminteraction')
...
for k=1:nF
    ...
    scores_VKBNMF = VKBNMF_paramater_ARD_sig(human_pro_sim, virus_pro_sim, train_set, 50); 
    predict_score1 = scores_VKBNMF(cv_data{k,2});    
